...
class TrabajosActuales
{
	...
	private $datos, $usuarios, $requ, $requ2, $prio1, $prio2, $suma;
	...
	{
		$sql = "select * from tb_trabajos_actuales";
	...
	public function anadirTrabajo($prio,$req1,$req2,$proye,$trab,$form,$moda,$obse,$link,$cant,$mont_vef,$tota_vef,$tiem,$asig)
	{
		
		$sql="insert into tb_trabajos_actuales values (null,'$prio','$req1','$req2','$proye','$trab','$form','$moda','$obse','$link','$cant','$mont_vef','$tota_vef','$tiem','$asig')";
		...
		echo "<script type='text/javascript'>
			...
			window.location='trabajos_actuales.php';
			</script>";

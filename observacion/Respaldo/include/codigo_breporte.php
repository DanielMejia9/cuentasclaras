...
<div id="cajaOpcion">
<form action="buscar_calculo.php" method="post">
<table border="0" align="right" width="100">
	<tr>
    	<td align="right">
        	<a href="#"><img src="imagen/atras.png"  width="30" border="0" value="Atras" onclick="location.href='buscar_reporte.php'" /></a><p class="atrasAllado" >Atrás</p>
        </td>
        <td>
        	<a href="#"><img src="imagen/Printer-icon[4].png" width="30" border="0" value="Imprimir" onclick=printPage();  /></a> <p class="atrasAllado" >Imprimir</p>
        </td>
    </tr>
</table>
</form>
...
if(isset($buscar)){
	if ($comprobar)
	{
		...
		alert ("Campo Vacio");
		location.href = "buscar_reporte.php";
		</script>
        <?php
	}
	if ($columna["rif_empresa"] == $rif){
		...
		//echo $rif;
		echo '
				<h3>Reporte Mensual Cliente '.$empresa.' </h3>

...
<form name="form_mod_ofer" id="form_mod_ofer" action="modificar_ofertas.php?codi_trab=<?php echo $mod[0]['id_ofer'] ?>" method="post">
<input type="hidden" name="cod_uniofer" id="cod_uniofer"  value="<?php echo $mod[0]['id_ofer'] ?>"/> 
				<div id="fila">
                    <div id="columna" style="float:left; width:33%">
                    	<span class="desc">ID: <?php echo $mod[0]['id_ofer'] ?></span>
                ...
                <div id="fila">  
                   <div id="columna" style="float:left; width:50%">
                        ...
                        <textarea id="proye" name="proye" cols="35" rows="8"><?php echo $mod[0]['proy_ofer'] ?></textarea>
                   </div>
                   <div id="columna" style="float:left; width:50%">
                   		<span class="desc">Trabajo:</span>  
                        <textarea id="trab" name="trab" cols="35" rows="8"><?php echo $mod[0]['trab_ofer'] ?></textarea>
                   </div>
                </div>
                <div id="fila">  
                   ...
                   <div id="columna" style="float:left; width:33%">
                        ...
                        <textarea id="obse" name="obse" cols="35" rows="8"><?php echo $mod[0]['obse_ofer'] ?></textarea>
                   </div>
                </div>
                 <div id="fila">
                   <div id="columna" style="float:left; width:33%">
                   		<span class="desc">Cantidad de Trabajo: </span>
                       <input type="text" id="cant" name="cant" value="<?php echo $mod[0]['cant_ofer'] ?>"   onkeyup="sumarCantidad();" />
                   </div>
                   <div id="columna" style="float:left; width:33%">
                   		<span class="desc">Monto Bsf: </span>
                       <input type="text" id="mont_vef" name="mont_vef" value="<?php echo $mod[0]['mont_bsf_ofer'] ?>" onkeyup="sumarCantidad();" />
                   </div>
                   <div id="columna" style="float:left; width:33%">
                   		<span class="desc">Total Trabajo Bsf: </span>
                       <input type="text" id="tota_vef" name="tota_vef"  value="<?php echo $mod[0]['tota_vef_ofer'] ?>" onkeyup="sumarCantidad();" />
                   </div>
                </div>
                <div id="fila">  
                   <div id="columna" style="float:left; width:50%">
                   		<span class="desc">Tiempo Estimado: </span>
                       <input type="text" id="tiem" name="tiem" value="<?php echo $mod[0]['tiem_esti_ofer'] ?>" />
                   </div>
                   <?php 
				   if($rol==1)
				   {

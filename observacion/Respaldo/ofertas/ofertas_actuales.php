				 ...
				 for($i=0; $i<sizeof($paginacion); $i++)
                  {
                    ...
                    ?>
                        ...
                        <a href="javascript:void(0);" onclick="window.location='modificar_ofertas.php?codi_trab=<?php echo $row[$i]["id_ofer"]?>'">
                        <div class="columna tabla corto contenido" ><?php echo $row[$i]["id_ofer"] ?></div>
                        ...
                        <div class="columna tabla largo contenido" ><?php if (strlen($row[$i]["trab_ofer"]) >= 250){echo  substr(wordwrap(ucwords($row[$i]["trab_ofer"]), 250, "<br>",1),0,250)." <span class='leerMas'>Leer mas.</span>";}else{echo  substr(wordwrap(ucwords($row[$i]["trab_ofer"]), 250, "<br>",1),0,250);}?></div>
                        <div class="columna tabla largo contenido" ><?php if (strlen($row[$i]["proy_ofer"]) >= 250){echo  substr(wordwrap(ucwords($row[$i]["proy_ofer"]), 250, "<br>",1),0,250)." <span class='leerMas'>Leer mas.</span>";}else{echo  substr(wordwrap(ucwords($row[$i]["proy_ofer"]), 250, "<br>",1),0,250);}?></div>
                        <div class="columna tabla medio contenido"><?php echo number_format($row[$i]["mont_bsf_ofer"], 2, ',', '.')." Bsf"?></div>
                        <div class="columna tabla medio contenido"><?php echo number_format($row[$i]["tota_vef_ofer"], 2, ',', '.')." Bsf"?></div>
                        <?php
						...
						{
						?>
						<div class="columna tabla corto contenido"><img src="../images/eliminar.png"   style="cursor:pointer;" title="Eliminar" width="32" align="center" onclick="eliminarOfer(<?php echo $row[$i]["id_ofer"]?>)"></div>
						<?php
						}
						?>	
                        </div>

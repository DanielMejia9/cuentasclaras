    ...
    <div id="cuerpo_general">
    	...
    	<div id="contenedor">
                ...
                <form name="form_clie" id="form_clie" action="add_cliente.php" method="post">
                    <table border="0" width="900" height="150" align="center" id="RegClien" class="regUser">
                        <tr>
                        <tr>
                            <td>
                       ...
                       <tr>
                            <td>
                                ...
                                Telefonos*: <input type="text" name="telEmpr" id="telEmpr" maxlength="14" size="20" />
                                 Telefonos(opcional): <input type="text" name="telEmpropc" id="telEmpropc" maxlength="14" size="20" />
                                Contr: 
                        ...
                        <!-- <tr>
                            <td>
                                <div style="background:rgb(245, 245, 245); text-align:left; padding: 10px 0px 0px 10px; height:30px; border: 1px  #C0C0C0 solid;">
                				<span style="color: #003E55; font-weight:bold;">Datos del Contacto </span>
                				</div>
                            </td>
                        </tr>
                        <tr>

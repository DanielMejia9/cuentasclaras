    ...
    <div id="cuerpo_general">
    	...
    	<div id="contenedor-cliente">
...

                {
                    ...
                    <td style="padding-left:14px"><a href="javascript:void(0);" onclick="window.location='ver_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo $row[$i]["codi_clie"] ?></a></td>
                    
                    <td style="padding-left:10px" title="<?php echo ucwords($row[$i]["nomb_clie"])?>"><a href="javascript:void(0);" onclick="window.location='ver_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo substr(ucwords($row[$i]["nomb_clie"]),0,20);?></a></td>
                    <td style="padding-left:10px" width="100px"><a href="javascript:void(0);" onclick="window.location='ver_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo $row[$i]["rif_clie"]?></a></td>
                    <td style="padding-left:10px"><a href="javascript:void(0);" onclick="window.location='ver_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo substr($row[$i]["dire_clie"],0,50)."...";?></a></td>
                    <td style="padding-left:10px"><a href="javascript:void(0);" onclick="window.location='ver_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo ucwords($row[$i]["ciud_clie"])?></a></td>
                    <td style="padding-left:10px"><a href="javascript:void(0);" onclick="window.location='ver_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo ucwords($row[$i]["esta_clie"])?></a></td>
                    <td style="padding-left:10px"><a href="javascript:void(0);" onclick="window.location='ver_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo $row[$i]["tele_clie"]?></a></td>
                    <td style="padding-left:10px"><a href="javascript:void(0);" onclick="window.location='ver_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo $row[$i]["tele_clie_opci"]?></a></td>

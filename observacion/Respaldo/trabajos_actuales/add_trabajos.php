<?php include("start.php");
	  ...
	  if(isset($_POST["anadir"]) and $_POST["anadir"]=="si")
		...
		$anadir = $trabajo->anadirTrabajo($_POST["prio"],$_POST["req1"],$_POST["req2"],$_POST["proye"],
		$_POST["trab"],$_POST["form"],$_POST["moda"],$_POST["obse"],$_POST["link"],$_POST["cant"],$_POST["mont_vef"],
		$_POST["tota_vef"],$_POST["tiem"],$_POST["asigna_usuario"]);
			exit;
		}

...
<input type="hidden" name="cod_uniofer" id="cod_uniofer"  value="<?php echo $mod[0]['id_trab'] ?>"/> 
                ...
                <div id="fila">  
                   ...
                   <div id="columna" style="float:left; width:33%">
                         ...
                         <?php 
							$row = $oferta->libCombo($_GET["codi_trab"],'oferta','id_ofer');
                ...
                <div id="fila">  
                   ...
                   <div id="columna" style="float:left; width:16%">
                        ...
                        <textarea id="solicitud" name="solicitud" cols="35" rows="8">
							<?php 
                            $solicitud = $oferta->solicitudDelUsuario($_GET["codi_trab"]);
                  ...
                  <div id="columna" class="caja" style="float:left; width:33%">
                       ...
                       <?php
						...
						{					
							$visu = $oferta->checkboxUsuarios($usuario);
							for($j=0;$j<sizeof($visu);$j++)
						   {
						   ?>
						   <div id="conteRadio"><input type="checkbox" name="queusuario[]" value="<?php echo $visu[$j]['id_usuario']; ?>" /><?php echo $visu[$j]['nomb_usuario'] ?></div>
						   <?php  
						   }
						}
						if(mysql_num_rows($resultado)>0)
						{
							$visu = $oferta->checkbox($_GET['codi_trab'],$usuario);
						   ...
						   $sele = $oferta->selectCheckbok($_GET['codi_trab'],$usuario);
                   ...
                   <div id="columna" class="caja" style="float:left; width:33%">
                       ...
                       <?php
						...
						{					
							$visuAsig = $oferta->checkboxUsuariosAsig($usuario);
						...
						if(mysql_num_rows($resultado1)>0)
						{
							$check = $oferta->checkboxAsig($_GET['codi_trab'],$usuario);
						   ...
						   $seleAsig = $oferta->selectCheckbokAsig($_GET['codi_trab'],$usuario);
                    ...
                    <!--<div id="columna" style="float:left; width:33%">
                    	<span class="desc">Asignar a Usuario: </span>

...
<div id="fila_columna_filtro">
    	  ...
    	  <div id="columna2">
                <div id="cuerpo_general">
               	 	<div id="tilulos">
                     	<h2 style="padding-top:12px; width:200px;float:left;">Reporte Pagos</h2>
                            <div id="botenes">
                            	<div id="content">
                                    <div class="filtro">
                            ...
                            <center>
                                <div id="sub-contenedor-cliente"> 
                                    <div class="fila tabla titulo">
                                                ...
                                                <div class="columna tabla largo">Fecha desde</div>
                                                <div class="columna tabla largo">Fecha Hasta</div>
                                                <div class="columna tabla largo">Trabajo</div>
                                                <div class="columna tabla medio">Numero Deposito</div>
                                                <div class="columna tabla medio">Total Pago</div>

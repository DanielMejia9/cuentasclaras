				...
				if(data.length != 0){
					$.each(data, function(i,item){
						html += '<div class="fila tabla filaContenido">'
							...
							html += '<div class="columna tabla corto contenido"><a href="modificar_trabajos.php?codi_trab='+item.id_trab+'"><img src="../images/modificar.png" style="cursor:pointer;" width="32" title="Modificar" align="center"/></a></div>'
							html += '<div class="columna tabla corto contenido"><img src="../images/eliminar.png"   style="cursor:pointer;" title="Eliminar" width="32" align="center" onclick="eliminarTrab('+item.id_trab+')"></div>'

    	...
    	<div id="contenedor">
                ...
                <div id="fila">  
                   ...
                   <div id="columna" style="float:left; width:50%">
                        ...
                        <textarea id="proye" name="proye" cols="35" rows="8"  maxlength="999"><?php echo $mod[0]['proy_trab'] ?></textarea>
                   </div>
                   <div id="columna" style="float:left; width:50%">
                   		<span class="desc">Trabajo:</span>  
                        <textarea id="trab" name="trab" cols="35" rows="8"  maxlength="999"><?php echo $mod[0]['trab_trab'] ?></textarea>
                   </div> 
                </div>
                <div id="fila">  
                   ...
                   <div id="columna" style="float:left; width:33%">
                        ...
                        <select id="form" name="form" >
                         <?php 
							$row = $trabajo->libCombo($_GET["codi_trab"],"tb_trabajos_actuales",'id_trab');
                   ...
                   <div id="columna" style="float:left; width:33%">
                        ...
                        <select id="moda" name="moda" >
                         <?php 
							$row = $trabajo->libCombo2($_GET["codi_trab"],"tb_trabajos_actuales",'id_trab');
							for($i=0;$i<sizeof($row);$i++)
							{
                   ...
                   <div id="columna" style="float:left; width:33%">
                        ...
                        <textarea id="obse" name="obse" cols="35" rows="8"  maxlength="999"><?php echo $mod[0]['obse_trab'] ?></textarea>
                   </div>
                </div>
                 <div id="fila">  
                ...
                <div id="fila">  
                   ...
                   <div id="columna" style="float:left; width:16%">
				   ...
				   ?>
                   <div id="columna" style="float:left; width:16%">
                    	<span class="desc">Solicitado por: </span>
                        <textarea id="solicitud" name="solicitud" cols="35" rows="8">
							<?php 
                            $solicitud = $trabajo->solicitudDelUsuario($_GET["codi_trab"]);
                            for($y=0;$y<sizeof($solicitud);$y++)
                            {
                                echo $solicitud[$y]["nomb_usuario"]." / ";
                            }
                           ?>
                       </textarea>
                   	</div>
                   <div id="columna" class="caja" style="float:left; width:33%">
                       ...
                       <?php
						...
						{					
							$vsr = $trabajo->checkboxUsuarios($usuario);
						...
						if(mysql_num_rows($resultado)>0)
						{
							$visu = $trabajo->checkbox($_GET['codi_trab'],$usuario);
						   ...
						   $sele = $trabajo->selectCheckbok($_GET['codi_trab'],$usuario);
                   ...
                   <div id="columna" class="caja" style="float:left; width:33%">
                       ...
                       <?php
						...
						{					
							$visuAsig = $trabajo->checkboxUsuariosAsig($usuario);
							for($w=0;$w<sizeof($visuAsig);$w++)
						   {
						   ?>
						   <div id="conteRadio"><input type="checkbox" name="asigna_usuario[]"  id="asigna_usuario[]" value="<?php echo $visuAsig[$w]['id_usuario']; ?>" /><?php echo $visuAsig[$w]['nomb_usuario'] ?></div>
						   <?php  
						   }
						}
						if(mysql_num_rows($resultado1)>0)
						{
							$check = $trabajo->checkboxAsig($_GET['codi_trab'],$usuario);
						   ...
						   $seleAsig = $trabajo->selectCheckbokAsig($_GET['codi_trab'],$usuario);
